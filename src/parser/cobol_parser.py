...
class CobolParser:
    ...
    def __init__(self, use_generated: bool = True):
        ...
        self._parser = None
        self._lexer = None
        self._error_listener: Optional[CobolErrorListener] = None
    ...
    def _import_generated_parser(self):
        ...
        try:
            ...
            try:
                from .generated.Cobol85Lexer import Cobol85Lexer  # type: ignore[import-not-found]
                from .generated.Cobol85Parser import Cobol85Parser  # type: ignore[import-not-found]
    ...
    def _parse_with_antlr(self, source: str) -> Any:
        ...
        # Check for errors
        assert self._error_listener is not None

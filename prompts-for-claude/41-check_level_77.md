If you launch the command "python3 kyco-input-data/run_analyze_with_tree.py" you launch the api "analyze_with_tree" and produce 2 json files that represent:
...
For instance, the field FLAG-MOTOR (a level 77) is actually modified by the instruction:

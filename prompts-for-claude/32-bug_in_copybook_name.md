If you run the command "python3 sample-input-data/run_data_division_tree.py" you can test the api "get_data_division_tree" against a complex cobol source file.
...
This snippet says that the "copybook" is "COPYBOOK" while it should have been "DATAGRP-C".
